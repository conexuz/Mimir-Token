...
contract Governance is Ownable {
    ...
    // ============== CONTRACT VARIABLES FOR VOTING ==============
    
    // voting token contract address
    address public constant TRUSTED_TOKEN_ADDRESS = 0x123; //Mimir Token
    
    
    // duration since proposal creation till users can vote
    uint public constant VOTE_DURATION = 3 days; // vote duration
    
    uint public constant MIN_DEPOSIT_FOR_ONE_VOTE = 1e18;
    
    uint public constant MAX_VOTES_DEPOSIT = 10 * MIN_DEPOSIT_FOR_ONE_VOTE;
